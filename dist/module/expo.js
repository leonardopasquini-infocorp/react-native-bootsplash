...
import { hfs, log, PACKAGE_NAME, requireAddon, setIsExpo, transformProps, writeAndroidAssets, writeGenericAssets, writeIOSAssets, writeWebAssets } from "./generate";
...
export const withBootSplash = Expo.createRunOncePlugin((expoConfig, baseProps) => {
  const {
    platforms = [],
    sdkVersion = "0.1.0"
  } = expoConfig;
